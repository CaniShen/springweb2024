...
public class BancaController {
	...
	public String validarCuenta(@RequestParam("numCuenta") int numCuenta, HttpSession session) {
		if(bancaService.validarCuenta(numCuenta)) {
			session.setAttribute("titular", bancaService.titularesCuenta(numCuenta).get(0));
